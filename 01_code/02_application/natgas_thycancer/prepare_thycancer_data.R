####
# Prepare thyroid cancer datasets ----
####
...
hout<-read.csv('00_data/02_application/01_raw/thyroid.csv')
...
####
## outcome: thyroid cancer mortality rate 1980-2014 ----
####
...
# save dataset
saveRDS(test2, "00_data/02_application/02_preprocess/thycancer.rds")




####
## outcome: change in thyroid mortality rate 1980-2014 ----
####
...
# save dataset
saveRDS(test2, "00_data/02_application/02_preprocess/thycancer_change.rds")